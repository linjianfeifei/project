...
use app\admin\model\Man as ManModel;
...
class Man extends Base
{
    ...
    {
//        $data=Db::table('man')->where('sex',1)->find();
//        $this->assign("data", $data);
        $this->view->assign('title', '男运动员列表');
        $this->view->assign('keywords', '');
        $this->view->assign('desc', '');

        $this->view->count = ManModel::count();//查询数据数量

        $list = ManModel::paginate(8); //每页显示6条
    ...
    public function adminEdit(Request $request)
    {
        ...
        $result = ManModel::get($user_id);
        $this->view->assign('title', '男运动员修改');
        $this->view->assign('keywords', '男运动员修改');
        $this->view->assign('desc', '男运动员修改');
...
//        $data = $request -> param();
        ...
        $result = ManModel::update($data, $condition);
    ...
    {
        $user_id = $request->param('id');
        ManModel::update(['is_delete' => 1], ['id' => $user_id]);
        ManModel::destroy($user_id);
    ...
    {
        ManModel::update(['delete_time' => NULL], ['is_delete' => 1]);
    }
    ...
    {
        $this->view->assign('title', '添加男运动员员');
        $this->view->assign('keywords', '');
        $this->view->assign('desc', '');
...
//
        $data = input('post.');
//        dump($data);
        $code = Db::execute("insert into man value(null,1,:name,:password,:realname,1,:stu_num,:tel,:grade,:spe,:class,'未报名',0,'暂未设置','未报名',0,'暂未设置','未报名',0,'暂未设置','未报名',0,'暂未设置','未报名',0,'暂未设置','未报名',0,'暂未设置','未报名',0,'暂未设置','未报名',0,'暂未设置','未报名',0,'暂未设置','未报名',0,'暂未设置',null,null,null)", $data);
    ...
    public function ranking1()
    {
        ...
        $list = Db::table('man')->where('art1', '100米')->select();
        $this->view->assign('list', $list);
    ...
    public function ranking2()
    {
        ...
        $list = Db::table('man')->where('art2', '200米')->select();
        $this->view->assign('list', $list);
    ...
    public function ranking3()
    {
        ...
        $list = Db::table('man')->where('art3', '400米')->select();
        $this->view->assign('list', $list);
    ...
    public function ranking4()
    {
        ...
        $list = Db::table('man')->where('art4', '800米')->select();
        $this->view->assign('list', $list);
    ...
    public function ranking5()
    {
        ...
        $list = Db::table('man')->where('art5', '1500米')->select();
        $this->view->assign('list', $list);
    ...
    public function ranking6()
    {
        ...
        $list = Db::table('man')->where('art6', '实心球')->select();
        $this->view->assign('list', $list);
    ...
    public function ranking7()
    {
        ...
        $list = Db::table('man')->where('art7', '铅球（7.26KG）')->select();
        $this->view->assign('list', $list);
    ...
    public function ranking8()
    {
        ...
        $list = Db::table('man')->where('art8', '跳远')->select();
        $this->view->assign('list', $list);
    ...
    public function ranking10()
    {
        ...
        $list = Db::table('man')->where('art10', '跳高')->select();
        $this->view->assign('list', $list);
...
//        Db::table()->update():
    ...
    public function time()
    {
        ...
        $list1 = Db::table('man')->where('art1', '100米')->limit(1)->select();
        $this->view->assign('list1', $list1);

        $list2 = Db::table('man')->where('art2', '200米')->limit(1)->select();
        $this->view->assign('list2', $list2);

        $list3 = Db::table('man')->where('art3', '400米')->limit(1)->select();
        $this->view->assign('list3', $list3);

        $list4 = Db::table('man')->where('art4', '800米')->limit(1)->select();
        $this->view->assign('list4', $list4);

        $list5 = Db::table('man')->where('art5', '1500米')->limit(1)->select();
        $this->view->assign('list5', $list5);

        $list6 = Db::table('man')->where('art6', '实心球')->limit(1)->select();
        $this->view->assign('list6', $list6);

        $list7 = Db::table('man')->where('art7', '铅球（7.26KG）')->limit(1)->select();
        $this->view->assign('list7', $list7);

        $list8 = Db::table('man')->where('art8', '跳远')->limit(1)->select();
        $this->view->assign('list8', $list8);

        $list9 = Db::table('man')->where('art9', '三级跳远')->limit(1)->select();
        $this->view->assign('list9', $list9);

        $list10 = Db::table('man')->where('art10', '跳高')->limit(1)->select();
    ...
    public function changeTime_edit1(Request $request)
    {
        ...
        $result = ManModel::where('art1', '=', '100米')->update([
            'time1' => $data['time1']
        ]);
        if (true == $result) {
            return ['status' => 1, 'message' => '更新成功'];
    ...
    public function changeTime_edit2(Request $request)
    {
        ...
        $result = ManModel::where('art2', '=', '200米')->update([
            'time2' => $data['time2']
        ]);
        if (true == $result) {
            return ['status' => 1, 'message' => '更新成功'];
    ...
    public function changeTime_edit3(Request $request)
    {
        ...
        $result = ManModel::where('art3', '=', '400米')->update([
            'time3' => $data['time3']
        ]);
        if (true == $result) {
            return ['status' => 1, 'message' => '更新成功'];
    ...
    public function changeTime_edit4(Request $request)
    {
        ...
        $result = ManModel::where('art4', '=', '800米')->update([
            'time4' => $data['time4']
        ]);
        if (true == $result) {
            return ['status' => 1, 'message' => '更新成功'];
    ...
    public function changeTime_edit5(Request $request)
    {
        ...
        $result = ManModel::where('art5', '=', '1500米')->update([
            'time5' => $data['time5']
        ]);
        if (true == $result) {
            return ['status' => 1, 'message' => '更新成功'];
    ...
    public function changeTime_edit6(Request $request)
    {
        ...
        $result = ManModel::where('art6', '=', '实心球')->update([
            'time6' => $data['time6']
        ]);
        if (true == $result) {
            return ['status' => 1, 'message' => '更新成功'];
    ...
    public function changeTime_edit7(Request $request)
    {
        ...
        $result = ManModel::where('art7', '=', '铅球（7.26KG）')->update([
            'time7' => $data['time7']
        ]);
        if (true == $result) {
            return ['status' => 1, 'message' => '更新成功'];
    ...
    public function changeTime_edit8(Request $request)
    {
        ...
        $result = ManModel::where('art8', '=', '跳远')->update([
            'time8' => $data['time8']
        ]);
        if (true == $result) {
            return ['status' => 1, 'message' => '更新成功'];
    ...
    public function changeTime_edit9(Request $request)
    {
        ...
        $result = ManModel::where('art9', '=', '三级跳远')->update([
            'time9' => $data['time9']
        ]);
        if (true == $result) {
            return ['status' => 1, 'message' => '更新成功'];
    ...
    public function changeTime_edit10(Request $request)
    {
        ...
        $result = ManModel::where('art10', '=', '跳高')->update([
            'time10' => $data['time10']
        ]);
        if (true == $result) {
            return ['status' => 1, 'message' => '更新成功'];
    ...
    public function situation1()
    {
        ...
        $this->view->count = Db::table('man')->where('art1', '100米')->count();//查询数据数量
    ...
    public function situation2()
    {
        ...
        $this->view->count = Db::table('man')->where('art2', '200米')->count();//查询数据数量
    ...
    public function situation3()
    {
        ...
        $this->view->count = Db::table('man')->where('art3', '400米')->count();//查询数据数量
    ...
    public function situation4()
    {
        ...
        $this->view->count = Db::table('man')->where('art4', '800米')->count();//查询数据数量
    ...
    public function situation5()
    {
        ...
        $this->view->count = Db::table('man')->where('art5', '1500米')->count();//查询数据数量
    ...
    public function situation6()
    {
        ...
        $this->view->count = Db::table('man')->where('art6', '实心球')->count();//查询数据数量
    ...
    public function situation7()
    {
        ...
        $this->view->count = Db::table('man')->where('art7', '铅球（7.26KG）')->count();//查询数据数量
    ...
    public function situation8()
    {
        ...
        $this->view->count = Db::table('man')->where('art8', '跳远')->count();//查询数据数量
    ...
    public function situation9()
    {
        ...
        $this->view->count = Db::table('man')->where('art9', '三级跳远')->count();//查询数据数量
    ...
    public function situation10()
    {
        ...
        $this->view->count = Db::table('man')->where('art10', '跳高')->count();//查询数据数量
    ...
    {
        $this->view->assign('title', '男子项目历史记录');
        $this->view->assign('keywords', '');
        $this->view->assign('desc', '');

        //100米最好成绩
        $list1 = Db::table('man')->where('score1 > 0')->order("score1 asc")->limit(1)->find();
        //插入数据库man_history中
        Db::table('man_history')->insert($list1);
        $data1 = Db::table('man_history')->where('score1 > 0')->order("score1 asc")->limit(1)->select();
        $this->view->assign('data1', $data1);

        //200米最好成绩
        $list2 = Db::table('man')->where('score2 > 0')->order("score2 asc")->limit(1)->find();
        //插入数据库man_history中
        Db::table('man_history')->insert($list2);
        $data2 = Db::table('man_history')->where('score2 > 0')->order("score2 asc")->limit(1)->select();
        $this->view->assign('data2', $data2);

        //400米最好成绩
        $list3 = Db::table('man')->where('score3 > 0')->order("score3 asc")->limit(1)->find();
        //插入数据库man_history中
        Db::table('man_history')->insert($list3);
        $data3 = Db::table('man_history')->where('score3 > 0')->order("score3 asc")->limit(1)->select();
        $this->view->assign('data3', $data3);

        //800米最好成绩
        $list4 = Db::table('man')->where('score4 > 0')->order("score4 asc")->limit(1)->find();
        //插入数据库man_history中
        Db::table('man_history')->insert($list4);
        $data4 = Db::table('man_history')->where('score4 > 0')->order("score4 asc")->limit(1)->select();
        $this->view->assign('data4', $data4);

        //1500米最好成绩
        $list5 = Db::table('man')->where('score5 > 0')->order("score5 asc")->limit(1)->find();
        //插入数据库man_history中
        Db::table('man_history')->insert($list5);
        $data5 = Db::table('man_history')->where('score5 > 0')->order("score5 asc")->limit(1)->select();
        $this->view->assign('data5', $data5);

        //实心球最好成绩
        $list6 = Db::table('man')->where('score6 > 0')->order("score6 desc")->limit(1)->find();
        //插入数据库man_history中
        Db::table('man_history')->insert($list6);
        $data6 = Db::table('man_history')->where('score6 > 0')->order("score6 desc")->limit(1)->select();
        $this->view->assign('data6', $data6);

        //铅球（7.26KG）最好成绩
        $list7 = Db::table('man')->where('score7 > 0')->order("score7 desc")->limit(1)->find();
        //插入数据库man_history中
        Db::table('man_history')->insert($list7);
        $data7 = Db::table('man_history')->where('score7 > 0')->order("score7 desc")->limit(1)->select();
        $this->view->assign('data7', $data7);

        //跳远最好成绩
        $list8 = Db::table('man')->where('score8 > 0')->order("score8 desc")->limit(1)->find();
        //插入数据库man_history中
        Db::table('man_history')->insert($list8);
        $data8 = Db::table('man_history')->where('score8 > 0')->order("score8 desc")->limit(1)->select();
        $this->view->assign('data8', $data8);

        //三级跳远最好成绩
        $list9 = Db::table('man')->where('score9 > 0')->order("score9 desc")->limit(1)->find();
        //插入数据库man_history中
        Db::table('man_history')->insert($list9);
        $data9 = Db::table('man_history')->where('score9 > 0')->order("score9 desc")->limit(1)->select();
        $this->view->assign('data9', $data9);

        //跳高最好成绩
        $list10 = Db::table('man')->where('score10 > 0')->order("score10 desc")->limit(1)->find();
        //插入数据库man_history中
        Db::table('man_history')->insert($list10);
        $data10 = Db::table('man_history')->where('score10 > 0')->order("score10 desc")->limit(1)->select();
        $this->view->assign('data10', $data10);

        return $this->fetch('man_history');
    }
