...
class Man extends Base
{
    ...
    public function index()
    {
        ...
        $list=Db::table('man')->where('id',$id)->select();
    ...
    public function adminEdit(Request $request)
    {
        ...
        $this->view->assign('keywords','男运动员列表');
        $this->view->assign('desc','男运动员列表');
...
//个人成绩查询
    ...
    public function ranking1()
    {
        ...
        $list=Db::table('man')->where('art1','100米')->order('score1 asc')->limit(10)->select();
        $this -> view -> assign('list', $list);
    ...
    public function ranking2()
    {
        ...
        $list=Db::table('man')->where('art2','200米')->order('score2 asc')->limit(10)->select();
        $this -> view -> assign('list', $list);
    ...
    public function ranking3()
    {
        ...
        $list=Db::table('man')->where('art3','400米')->order('score3 asc')->limit(10)->select();
        $this -> view -> assign('list', $list);
    ...
    public function ranking4()
    {
        ...
        $list=Db::table('man')->where('art4','800米')->order('score4 asc')->limit(10)->select();
        $this -> view -> assign('list', $list);
    ...
    public function ranking5()
    {
        ...
        $list=Db::table('man')->where('art5','1500米')->order('score5 asc')->limit(10)->select();
        $this -> view -> assign('list', $list);
    ...
    public function ranking6()
    {
        ...
        $list=Db::table('man')->where('art6','实心球')->order('score6 asc')->limit(10)->select();
        $this -> view -> assign('list', $list);
    ...
    public function ranking7()
    {
        ...
        $list=Db::table('man')->where('art7','铅球（7.26KG）')->order('score7 asc')->limit(10)->select();
        $this -> view -> assign('list', $list);
    ...
    public function ranking8()
    {
        ...
        $list=Db::table('man')->where('art8','跳远')->order('score8 asc')->limit(10)->select();
        $this -> view -> assign('list', $list);
    ...
    public function ranking9()
    {
        ...
        $list=Db::table('man')->where('art9','三级跳远')->order('score9 asc')->limit(10)->select();
        $this -> view -> assign('list', $list);
    ...
    public function ranking10()
    {
        ...
        $list=Db::table('man')->where('art10','跳高')->order('score10 asc')->limit(10)->select();
        $this -> view -> assign('list', $list);
